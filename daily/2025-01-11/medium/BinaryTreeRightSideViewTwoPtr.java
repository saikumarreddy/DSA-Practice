/**
 * Problem: Binary Tree Right Side View [TwoPtr]
...
public class BinaryTreeRightSideViewTwoPtr {
    ...
    public static void main(String[] args) {
        BinaryTreeRightSideViewTwoPtr sol = new BinaryTreeRightSideViewTwoPtr();
