/**
 * Problem: Combination Sum [BruteForce]
...
public class CombinationSumBacktrackBruteForce {
    ...
    public static void main(String[] args) {
        CombinationSumBacktrackBruteForce sol = new CombinationSumBacktrackBruteForce();
