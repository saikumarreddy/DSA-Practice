 ...
 *
 * Approach: 0/1 Knapsack — find subset summing to total/2 using boolean DP.
 * Time:  O(n*sum)
 * Space: O(sum)
 */

public class CanPartitionEqualSubset {
    ...
    public static void main(String[] args) {
        CanPartitionEqualSubset sol = new CanPartitionEqualSubset();
