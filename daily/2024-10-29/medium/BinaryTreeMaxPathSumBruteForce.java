/**
 * Problem: Binary Tree Maximum Path Sum [BruteForce]
...
public class BinaryTreeMaxPathSumBruteForce {
    ...
    public static void main(String[] args) {
        BinaryTreeMaxPathSumBruteForce sol = new BinaryTreeMaxPathSumBruteForce();
