/**
 * Problem: Binary Tree Maximum Path Sum [Recursive]
...
public class BinaryTreeMaxPathSumRecursive {
    ...
    public static void main(String[] args) {
        BinaryTreeMaxPathSumRecursive sol = new BinaryTreeMaxPathSumRecursive();
