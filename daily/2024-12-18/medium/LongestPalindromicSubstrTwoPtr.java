/**
 * Problem: Longest Palindromic Substring [TwoPtr]
...
public class LongestPalindromicSubstrTwoPtr {
    ...
    public static void main(String[] args) {
        LongestPalindromicSubstrTwoPtr sol = new LongestPalindromicSubstrTwoPtr();
