/**
 * Problem: Find First and Last Position of Element in Sorted Array [Recursive]
...
public class FindFirstLastPosRecursive {
    ...
    public static void main(String[] args) {
        FindFirstLastPosRecursive sol = new FindFirstLastPosRecursive();
