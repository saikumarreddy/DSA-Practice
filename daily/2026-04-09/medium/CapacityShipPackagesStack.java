/**
 * Problem: Capacity to Ship Packages Within D Days [Stack]
...
public class CapacityShipPackagesStack {
    ...
    public static void main(String[] args) {
        CapacityShipPackagesStack sol = new CapacityShipPackagesStack();
