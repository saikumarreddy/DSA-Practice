/**
 * Problem: Find First and Last Position of Element in Sorted Array [Stack]
...
public class FindFirstLastPosStack {
    ...
    public static void main(String[] args) {
        FindFirstLastPosStack sol = new FindFirstLastPosStack();
