/**
 * Problem: Combination Sum [Iterative]
...
public class CombinationSumBacktrackIterative {
    ...
    public static void main(String[] args) {
        CombinationSumBacktrackIterative sol = new CombinationSumBacktrackIterative();
