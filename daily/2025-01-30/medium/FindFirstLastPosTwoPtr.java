/**
 * Problem: Find First and Last Position of Element in Sorted Array [TwoPtr]
...
public class FindFirstLastPosTwoPtr {
    ...
    public static void main(String[] args) {
        FindFirstLastPosTwoPtr sol = new FindFirstLastPosTwoPtr();
