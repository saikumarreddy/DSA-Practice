/**
 * Problem: Find First and Last Position of Element in Sorted Array [BruteForce]
...
public class FindFirstLastPosBruteForce {
    ...
    public static void main(String[] args) {
        FindFirstLastPosBruteForce sol = new FindFirstLastPosBruteForce();
