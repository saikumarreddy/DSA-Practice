/**
 * Problem: Lowest Common Ancestor of a BST [TwoPtr]
...
public class LowestCommonAncestorBSTTwoPtr {
    ...
    public static void main(String[] args) {
        LowestCommonAncestorBSTTwoPtr sol = new LowestCommonAncestorBSTTwoPtr();
