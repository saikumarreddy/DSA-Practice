/**
 * Problem: Binary Tree Right Side View [BruteForce]
...
public class BinaryTreeRightSideViewBruteForce {
    ...
    public static void main(String[] args) {
        BinaryTreeRightSideViewBruteForce sol = new BinaryTreeRightSideViewBruteForce();
