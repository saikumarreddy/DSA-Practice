/**
 * Problem: Merge Two Sorted Lists [BruteForce]
...
public class MergeTwoSortedListsBruteForce {
    ...
    public static void main(String[] args) {
        MergeTwoSortedListsBruteForce sol = new MergeTwoSortedListsBruteForce();
