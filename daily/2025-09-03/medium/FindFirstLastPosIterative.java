/**
 * Problem: Find First and Last Position of Element in Sorted Array [Iterative]
...
public class FindFirstLastPosIterative {
    ...
    public static void main(String[] args) {
        FindFirstLastPosIterative sol = new FindFirstLastPosIterative();
