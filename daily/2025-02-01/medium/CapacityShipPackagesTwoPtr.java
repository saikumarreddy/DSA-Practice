/**
 * Problem: Capacity to Ship Packages Within D Days [TwoPtr]
...
public class CapacityShipPackagesTwoPtr {
    ...
    public static void main(String[] args) {
        CapacityShipPackagesTwoPtr sol = new CapacityShipPackagesTwoPtr();
