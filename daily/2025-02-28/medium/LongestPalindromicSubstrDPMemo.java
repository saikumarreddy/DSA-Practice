/**
 * Problem: Longest Palindromic Substring [DPMemo]
...
public class LongestPalindromicSubstrDPMemo {
    ...
    public static void main(String[] args) {
        LongestPalindromicSubstrDPMemo sol = new LongestPalindromicSubstrDPMemo();
