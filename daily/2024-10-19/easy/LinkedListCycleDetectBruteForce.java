/**
 * Problem: Linked List Cycle [BruteForce]
...
public class LinkedListCycleDetectBruteForce {
    ...
    public static void main(String[] args) {
        LinkedListCycleDetectBruteForce sol = new LinkedListCycleDetectBruteForce();
