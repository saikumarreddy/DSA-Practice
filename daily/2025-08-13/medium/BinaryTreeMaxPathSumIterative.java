/**
 * Problem: Binary Tree Maximum Path Sum [Iterative]
...
public class BinaryTreeMaxPathSumIterative {
    ...
    public static void main(String[] args) {
        BinaryTreeMaxPathSumIterative sol = new BinaryTreeMaxPathSumIterative();
