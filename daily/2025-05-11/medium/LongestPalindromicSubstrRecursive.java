/**
 * Problem: Longest Palindromic Substring [Recursive]
...
public class LongestPalindromicSubstrRecursive {
    ...
    public static void main(String[] args) {
        LongestPalindromicSubstrRecursive sol = new LongestPalindromicSubstrRecursive();
