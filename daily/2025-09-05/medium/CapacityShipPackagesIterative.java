/**
 * Problem: Capacity to Ship Packages Within D Days [Iterative]
...
public class CapacityShipPackagesIterative {
    ...
    public static void main(String[] args) {
        CapacityShipPackagesIterative sol = new CapacityShipPackagesIterative();
