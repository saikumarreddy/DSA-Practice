/**
 * Problem: Lowest Common Ancestor of a BST [Recursive]
...
public class LowestCommonAncestorBSTRecursive {
    ...
    public static void main(String[] args) {
        LowestCommonAncestorBSTRecursive sol = new LowestCommonAncestorBSTRecursive();
